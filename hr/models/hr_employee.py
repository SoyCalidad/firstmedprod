...
class HrEmployeePrivate(models.Model):
    ...
    remuneration = fields.Integer(string="Remuneracion")
    boss_department_id = fields.Many2one('hr.department', 'Cargo Jefe Inmediato')
    boss_name = fields.Many2one('hr.employee', 'Nombre del Jefe')
